                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form:form action="insertimageSP.htm" method="post" modelAttribute="image1" enctype="multipart/form-data">                                                                                                                                                                     
                                            <div class="form-group">
                                                <label>Tên sản phẩm:</label>
                                                <form:select path="maSP.maSP">
                                                    <c:forEach items="${listtable}" var="s">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <form:input type="file" path="maHA.image"/>
                                            </div>
                                ...
                                <div class="container">
                                    <div class="table-wrapper">
                                        ...
                                        <table class="table table-striped table-hover table-bordered">
                                            ...
                                            <tbody>                                                                                 
                                                <c:forEach items="${listtable1}" var="c" varStatus="m">
                                                    <tr>
                                                        <td>${m.count}</td>
                                                        <td>/<img src="/DuAnJAVAWeb/jspadmin/resources/imagesfrontend/${c.maHA.image}" width="100" height="100"/></td>
                                                        <td>${c.maSP.tenSP}</td>
                                                        <td>
